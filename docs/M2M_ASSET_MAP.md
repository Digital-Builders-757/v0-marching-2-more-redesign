...
| `m2m-partners-consult-evening-home.png` | `public/images/site/` | Site-wide | [`components/partners.tsx`](../components/partners.tsx), [`components/improve-your-credit/content.ts`](../components/improve-your-credit/content.ts) (`TAKEAWAYS_BACKGROUND`) | Homepage partner circle; credit takeaways backdrop |
...
| `m2m-downsizing-client-hero.png` | `public/images/downsizing/` | Downsizing | [`HERO_BACKGROUND`](../components/downsizing-your-home/content.ts), [`downsizing-hero.tsx`](../components/downsizing-your-home/downsizing-hero.tsx) | Hero (client campaign) |
| `m2m-downsizing-client-problems-banner.png` | `public/images/downsizing/` | Downsizing | [`PROBLEMS_SUPPORT_IMAGE`](../components/downsizing-your-home/content.ts), [`downsizing-problems.tsx`](../components/downsizing-your-home/downsizing-problems.tsx) | “Signs” editorial banner (client campaign) |
| `m2m-downsizing-hero-family-photo-album-transition.png` | `public/images/downsizing/` | Downsizing | *(on disk; superseded for hero)* | Archive / swap-in |
| `m2m-downsizing-signs-family-packing-kitchen.png` | `public/images/downsizing/` | Downsizing | *(on disk; superseded for problems banner)* | Archive / swap-in |
...
| `m2m-divorce-client-sell-during-collage.png` | `public/images/divorce/` | Divorce | Collage slot `sellDuringDivorce` in [`content.ts`](../components/navigating-divorce/content.ts) | Collage — planning / documents (client campaign) |
| `divorce-couple-contemplative.jpg` | `public/images/divorce/` | Divorce | *(on disk; superseded for collage slot 1)* | Archive / swap-in |
...
| `m2m-credit-client-home-goals-dashboard.png` | `public/images/credit/` | Credit | [`HERO_IMAGE_CENTER`](../components/improve-your-credit/content.ts), [`credit-hero.tsx`](../components/improve-your-credit/credit-hero.tsx) | Hero pillar — credit + home goals (client campaign) |
| `m2m-credit-couple-plan-together.png` | `public/images/credit/` | Credit | Homework collage + closing band ([`content.ts`](../components/improve-your-credit/content.ts)) | Collage + narrative band |
...
| `m2m-va-client-hero.png` | `public/images/va-loan/` | VA benefits | [`HERO_BACKGROUND`](../components/va-loan-benefits/content.ts), [`va-hero.tsx`](../components/va-loan-benefits/va-hero.tsx) | Hero (client campaign) |
| `m2m-va-client-cta.png` | `public/images/va-loan/` | VA benefits | [`CTA_BANNER_BACKGROUND`](../components/va-loan-benefits/content.ts), [`va-cta-banner.tsx`](../components/va-loan-benefits/va-cta-banner.tsx) | CTA band (client campaign) |
| `m2m-va-client-benefits-editorial.png` | `public/images/va-loan/` | VA benefits | [`BENEFITS_EDITORIAL_IMAGE`](../components/va-loan-benefits/content.ts), [`va-benefits-content.tsx`](../components/va-loan-benefits/va-benefits-content.tsx) | Benefits section editorial |
| `va-hero-military-homecoming.jpg` | `public/images/va-loan/` | VA benefits | *(on disk; superseded for hero)* | Archive / swap-in |
| `va-cta-patriotic-home.jpg` | `public/images/va-loan/` | VA benefits | *(on disk; superseded for CTA band)* | Archive / swap-in |
...
| `m2m-fha-client-hero.png` | `public/images/fha-loan/` | FHA | [`HERO_BACKGROUND`](../components/fha-loan/content.ts), [`fha-hero.tsx`](../components/fha-loan/fha-hero.tsx) | Hero (client campaign) |
| `m2m-fha-client-editorial.png` | `public/images/fha-loan/` | FHA | [`EDITORIAL_SECTION_IMAGE`](../components/fha-loan/content.ts), [`fha-editorial-image-band.tsx`](../components/fha-loan/fha-editorial-image-band.tsx) | Mid-page editorial band after trust strip |
| `fha-hero-first-time-buyer.jpg` | `public/images/fha-loan/` | FHA | *(on disk; optional hero swap)* | Reserve |
| `m2m-investments-client-hero.png` | `public/images/investments/` | More investments | [`more-investments/content.ts`](../components/more-investments/content.ts) (`HERO_SLIDES` intro) | Intro slide center (client campaign) |
| `ChatGPT Image May 3, 2026, …AM.png` (subset; URL-encoded in code) | `public/images/_original-client-delivery/` | More investments (`/more-investments`) | [`more-investments/content.ts`](../components/more-investments/content.ts) (`HERO_SLIDES`) — remaining slides | Hero carousel |
