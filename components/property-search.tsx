...
import { REALSCOUT_MAP_SEARCH_URL, mailtoNeedsHelp } from "@/lib/m2m-site"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        <div className="flex flex-col gap-9 order-2 lg:order-1">
          <div className="flex items-center gap-3 text-[0.6rem] tracking-[0.3em] uppercase text-m2m-gold">
            <div data-gsap="line-reveal" className="w-6 h-px bg-m2m-gold" />
          ...
          >
            We&apos;ve curated a range of properties that fit the lifestyle and requirements of military personnel and
            their families. From relocations to finding homes near military bases, we&apos;re here to support you at
            every step.
          </p>

          <div className="flex flex-col gap-3" data-gsap="stagger-children" data-gsap-direction="up">
        ...
        <div data-gsap="scale-in" className="order-1 lg:order-2">
