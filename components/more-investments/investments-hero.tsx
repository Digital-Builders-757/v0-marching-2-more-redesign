    ...
    <Carousel opts={{ loop: true, align: "start" }} setApi={setApi} className="w-full">
      <div className="relative overflow-hidden">
        ...
        <CarouselPrevious
          variant="ghost"
          className={cn(
            "absolute left-1 top-1/2 z-20 size-10 -translate-y-1/2 rounded-full border-0 bg-m2m-deep/25 text-m2m-gold shadow-none backdrop-blur-[2px]",
        ...
        <CarouselNext
          variant="ghost"
          className={cn(
            "absolute right-1 top-1/2 z-20 size-10 -translate-y-1/2 rounded-full border-0 bg-m2m-deep/25 text-m2m-gold shadow-none backdrop-blur-[2px]",
            "hover:bg-m2m-deep/45 hover:text-m2m-gold-lt",
            "disabled:opacity-30",
          )}
        />
