        ...
        <M2mContainer>
          ...
          <div className="grid grid-cols-1 gap-10 sm:gap-12 lg:grid-cols-12 lg:gap-x-14 lg:gap-y-10">
            ...
            <div className="order-2 min-w-0 lg:order-1 lg:col-span-3">
              ...
              {linkedin || instagram ? (
                <div className="mt-8 flex items-center gap-2 border-t border-m2m-deep/10 pt-8">
                  <span
                  ...
                  {linkedin ? (
                    <a href={linkedin} target="_blank" rel="noreferrer" className={socialIconClass} aria-label="LinkedIn">
