...
const teamMembers = [
  {
    ...
    roleLine: "Founding Partner • Licensed Agent",
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Donavan%20copy-R9RwXLWqjd9OnQw4gBl6EiAVWOj9x1.avif",
    ...
    profileHref: "/profile-page",
  },
  {
    name: "Roger Lee",
    roleLine: "Founding Partner • Licensed Agent",
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Roger%20Lee%20copy-ZbhqIDwo7JeGrBkKFa6Sv0ylWIuI1D.avif",
    ...
    profileHref: "/roger-lee",
  },
  {
    name: "Kristin Allen",
    roleLine: "Licensed Agent",
    image:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Kristin%20copy-lMfUtkHjgotsvjdeeUby9aj3quqUGu.avif",
    bio: "Kristin\u2019s attention to detail and genuine care for clients makes every transaction smooth and stress-free.",
    profileHref: "/kristin-s-profile",
  },
  {
          ...
          {teamMembers.map((member, index) => (
            ...
            >
              <div className="flex flex-col sm:flex-row gap-6 p-6 border border-m2m-deep/10 transition-all duration-300 hover:border-m2m-gold/30 hover:shadow-lg">
                <div className="w-full sm:w-40 h-48 sm:h-40 flex-shrink-0 overflow-hidden relative">
                  <Image
                    src={member.image}
                    alt=""
                    width={320}
