            ...
            <div data-gsap-child className="flex flex-col gap-4 mt-4 sm:flex-row">
              ...
              <div className="flex flex-col items-center gap-2 sm:items-start">
                <a
                  ...
                  data-gsap="magnetic"
                  className="inline-flex min-h-12 touch-manipulation items-center justify-center rounded-lg border border-white/25 bg-m2m-deep/80 px-8 py-4 text-center text-[0.7rem] uppercase tracking-[0.2em] text-m2m-cream [text-shadow:0_2px_12px_rgba(5,13,6,0.65)] shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] backdrop-blur-sm transition-all duration-300 hover:border-m2m-gold/70 hover:bg-m2m-deep/90 hover:text-m2m-cream focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-m2m-gold"
                  style={{ fontFamily: "var(--font-nav)" }}
                >
